...
const ProtocolServer = require('./i.js'); 
const HTTPServer = require('./i.s.js'); 
...
describe('ProtocolServer', () => {
    ...
    describe('lifecycle methods', () => {
        ...
        it('receive should call the "receiveMessage" event', async () => {
            const receiveMessageHandler = sinon.spy();
            protocolServer.on('receiveMessage', receiveMessageHandler);
        ...
        it('respond should call the "respondMessage" event and write to the socket if writable', async () => {
            const respondMessageHandler = sinon.spy();
            protocolServer.on('respondMessage', respondMessageHandler);
        ...
        it('respond should call the "respondMessage" event and warn if socket is not writable', async () => {
            const respondMessageHandler = sinon.spy();
            const warnSpy = sinon.spy(console, 'warn');
            protocolServer.on('respondMessage', respondMessageHandler);
...
describe('HTTPServer', () => {
    ...
    it('should create an HTTPServer instance and call ProtocolServer constructor', () => {
        ...
        expect(httpServer.eventHandlers.receiveMessage).to.not.be.undefined;
    });
